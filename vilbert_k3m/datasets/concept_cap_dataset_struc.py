...
class K3MDataLoader(object):
    ...
    def __init__(
        ...
        preprocess_function = K3MPreprocessBatch(tokenizer, max_seq_len=max_seq_len, max_seq_len_pv=max_seq_len_pv,
                                                 max_num_pv=max_num_pv, max_region_len=max_region_len,
                                                 v_target_size=v_target_size, v_feature_size=v_feature_size,
                                                 v_loc_size=v_loc_size, visual_target=visual_target)
    ...
    def __iter__(self):
        ...
        for batch in self.ds.get_data():
            label, item_id_1, input_ids_1, input_mask_1, segment_ids_1, input_ids_pv_1, input_mask_pv_1, segment_ids_pv_1, \
            index_p_1, index_v_1, num_boxes_1, image_feat_1, image_loc_1, image_target_1, image_mask_1, item_id_2, input_ids_2, \
            input_mask_2, segment_ids_2, input_ids_pv_2, input_mask_pv_2, segment_ids_pv_2, index_p_2, index_v_2, \
            num_boxes_2, image_feat_2, image_loc_2, image_target_2, image_mask_2 = ( batch )

            image_feat_1, image_loc_1, image_mask_1 = self.post_process(input_ids_1, num_boxes_1, image_feat_1, image_loc_1, image_mask_1)
            ...
            yield tuple([torch.tensor(data) for data in batch] + [item_id_1, index_p_1, index_v_1, item_id_2, index_p_2, index_v_2])
...
class K3MPreprocessBatch(object):
    def __init__(
            self,
            tokenizer,
            max_seq_len=32,
    ...
    def __call__(self, data):
        label, item_id_1, caption_1, pv_1, category_1, image_h_1, image_w_1, num_boxes_1, image_location_wp_1, image_feature_wp_1, \
        ...
        # Step 1: image processing
        image_feature_1, image_target_1, image_location_1 = self.image_processing(image_h_1, image_w_1, num_boxes_1,
                                                                                      image_location_wp_1, image_feature_wp_1,
                                                                                      image_target_wp_1)
        image_feature_2, image_target_2, image_location_2 = self.image_processing(image_h_2, image_w_2, num_boxes_2,
                                                                                              image_location_wp_2, image_feature_wp_2,
                                                                                              image_target_wp_2)

        # Step 2: text processing
        tokens_caption_1, tokens_pv_1 = self.text_processing(caption_1, pv_1)
        tokens_caption_2, tokens_pv_2 = self.text_processing(caption_2, pv_2)

        # Step 3: transform example to features
        cur_example_1 = InputExample(
            # title
            caption=tokens_caption_1,
            # item pvs
            pv=tokens_pv_1,
            # image
            image_feat=image_feature_1,
            image_target=image_target_1,
            image_loc=image_location_1,
            num_boxes=num_boxes_1,
            # overlaps=overlaps_1,
        )
        cur_features_1 = self.convert_example_to_features(cur_example_1)
        cur_example_2 = InputExample(
            # title
            caption=tokens_caption_2,
            # item pvs
            pv=tokens_pv_2,
            # image
            image_feat=image_feature_2,
            image_target=image_target_2,
            image_loc=image_location_2,
            num_boxes=num_boxes_2,
            # overlaps=overlaps_2,
        )
        cur_features_2 = self.convert_example_to_features(cur_example_2)
        # print(f"current features: {cur_features}")
        return (
            label,
            # item 1
            item_id_1,
            cur_features_1.input_ids,
            cur_features_1.input_mask,
            cur_features_1.segment_ids,
            # cur_features_1.lm_label_ids,
            # cur_features_1.is_next,
            cur_features_1.input_ids_pv,
            cur_features_1.input_mask_pv,
            cur_features_1.segment_ids_pv,
            # cur_features_1.lm_label_ids_pv,
            # cur_features_1.is_next_pv_v,
            # cur_features_1.is_next_pv_t,
            cur_features_1.index_p,
            cur_features_1.index_v,
            cur_features_1.num_boxes,
            cur_features_1.image_feat,
            cur_features_1.image_loc,
            cur_features_1.image_target,
            # cur_features_1.image_label,
            cur_features_1.image_mask,
            # cur_features_1.masked_label,
            # item 2
            item_id_2,
            cur_features_2.input_ids,
            cur_features_2.input_mask,
            cur_features_2.segment_ids,
            # cur_features_2.lm_label_ids,
            # cur_features_2.is_next,
            cur_features_2.input_ids_pv,
            cur_features_2.input_mask_pv,
            cur_features_2.segment_ids_pv,
            # cur_features_2.lm_label_ids_pv,
            # cur_features_2.is_next_pv_v,
            # cur_features_2.is_next_pv_t,
            cur_features_2.index_p,
            cur_features_2.index_v,
            cur_features_2.num_boxes,
            cur_features_2.image_feat,
            cur_features_2.image_loc,
            cur_features_2.image_target,
            # cur_features_2.image_label,
            cur_features_2.image_mask,
            # cur_features_2.masked_label,
        )

    def text_processing(self, caption, pv):
        # label, label_pv_t, label_pv_v = 0, 0, 0
        tokens_caption = self.tokenizer.encode(caption)
        tokens_pv = self.tokenizer.encode(pv)
        logger.debug(f"title:{caption}, tokens caption: {tokens_caption},"
        ...
        return tokens_caption, tokens_pv #, label, label_pv_t, label_pv_v
    ...
    def image_processing(self, image_h, image_w, num_boxes, image_location_wp, image_feature_wp,
                         image_target_wp):
        if num_boxes <= 0:
            # if no boxes are found, use default value
            image_h, image_w, num_boxes = 800, 800, 1
        ...
        return image_feature, image_target, image_location#, overlaps
