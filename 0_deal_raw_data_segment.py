...
def rename_pic(raw_data_path, segment_id):# 清洗数据，下载图片
    import glob
    pics = glob.glob("C:\\Users\\sunzeyeah\\Downloads\\train\\*" if segment_id == 0 else "C:\\Users\\sunzeyeah\\Downloads\\valid\\*")
    pic_dict = dict()
    for pic in pics:
        key = pic.split("\\")[-1]
        pic_dict[key] = pic
...
if __name__=='__main__':
    ...
    # rename_pic(raw_data_path_train, segment_id = 0)
    # rename_pic(raw_data_path_valid, segment_id = 1)
